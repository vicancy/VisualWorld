...
namespace WorldFramework.Controller
{
    ...
    static class ImageDDS
    {
        ...
        public static void LoadFromDisk( string filename, out uint texturehandle, out TextureTarget dimension )
        {
            ...
            texturehandle = Textures.TextureLoaderParameters.OpenGLDefaultTexture;
            ...
            try // Exceptions will be thrown if any Problem occurs while working on the file. 
            {
                ...
                if ( Textures.TextureLoaderParameters.Verbose )
                ...
                for ( int Slices = 0 ; Slices < _Depth ; Slices++ )
                {
                    ...
                    for ( int Level = 0 ; Level < _MipMapCount ; Level++ ) // start at base image
                    {
                        ...
                        if (Textures.TextureLoaderParameters.Verbose && Level == 0 && _IsCompressed && _BytesForMainSurface != SurfaceSizeInBytes)
                        ...
                        { // Note: there could be a potential problem with non-power-of-two cube maps
                            ...
                            if (!Textures.TextureLoaderParameters.FlipImages)
                            ...
                            case TextureTarget.Texture2D:
                                GL.CompressedTexImage2D( TextureTarget.Texture2D,
                                                         ...
                                                         Width,
                                                         Height,
                                                         Textures.TextureLoaderParameters.Border,
                                                         SurfaceSizeInBytes,
                                                         RawDataOfSurface );
                                break;
                ...
                GL.TexParameter(dimension, TextureParameterName.TextureMinFilter, (int)Textures.TextureLoaderParameters.MinificationFilter);
                GL.TexParameter(dimension, TextureParameterName.TextureMagFilter, (int)Textures.TextureLoaderParameters.MagnificationFilter);

                GL.TexParameter(dimension, TextureParameterName.TextureWrapS, (int)Textures.TextureLoaderParameters.WrapModeS);
                GL.TexParameter(dimension, TextureParameterName.TextureWrapT, (int)Textures.TextureLoaderParameters.WrapModeT);

                GL.TexEnv(TextureEnvTarget.TextureEnv, TextureEnvParameter.TextureEnvMode, (int)Textures.TextureLoaderParameters.EnvMode);
